...
* 🧠 **The CRE Workflow Simulation:** [`/cre-workflow/wrapup-cre/ai-audit/main.ts`](./cre-workflow/wrapup-cre/ai-audit/main.ts) *(This file contains the TypeScript logic executed by the CRE CLI to trigger the AI evaluation and format the on-chain payload).*
